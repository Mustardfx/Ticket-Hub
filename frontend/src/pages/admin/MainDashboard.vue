...
import ChartRevenue from '@/components/admin/statistics/ChartRevenue.vue'
...
<template>
    ...
    <div class="grid grid-cols-2 gap-4">
      <VisitorsCard :count="uniqueVisitors" title="Уникальные посетители" />
      <VisitorsCard
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
      ...
      <ChartRevenue :data="filteredRevenue" />
    </div>
  </div>
</template>
